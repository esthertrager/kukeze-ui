...
describe('ScaleRecipe', () => {
  it('changing one ingredient scales the rest of the ingredients and total', () => {
    ...
    expect(wrapper.find('[id="ingredient_amount_0"]').props().value).toBe(
      '400'
    );
    expect(wrapper.find('[id="ingredient_amount_1"]').props().value).toBe(
      '400'
    );
  ...
  it('changing an ingredient unit scales the ingredients and yield', () => {
    ...
    expect(wrapper.find('[id="ingredient_amount_0"]').props().value).toEqual(
      '400'
    );
    expect(wrapper.find('[id="ingredient_amount_1"]').props().value).toEqual(
      400000
    );
